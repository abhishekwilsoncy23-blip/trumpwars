const Level3 = (function() {
    ...
    let mibDirection = 1; 
    let mibSpeed = 0.6; // MUCH SLOWER horizontal movement
    let phase = 1; 
    ...
    return {
        init: function() {
            ...
            if(actionBtn) actionBtn.innerText = "FIRE";
            ...
            // REDUCED NUMBER OF MIBS: Only 1 row of 5 agents
            for(let c = 0; c < 5; c++) {
                mibs.push({ x: 50 + (c * 60), y: 80, width: 40, height: 40 });
            }
        },
        ...
        update: function() {
            ...
            if (phase === 1) {
                ...
                if (hitEdge) {
                    mibDirection *= -1;
                    mibs.forEach(mib => mib.y += 5); // NERF: Slower descent (was 10)
                }
